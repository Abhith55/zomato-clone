...
<div class="sidebar">
    <ul class="sidebar-nav">
        <li class="sidebar-item">
            ...
            <ul class="submenu">
          <li><a href="javascript:void(0);" onclick="location.href='${pageContext.request.contextPath}/user/add'">➕ Add User</a></li>
            <li><a href="javascript:void(0);" onclick="location.href='${pageContext.request.contextPath}/user'">📄 Show Users</a></li>
         </ul>
        </li>
        <li class="sidebar-item">
